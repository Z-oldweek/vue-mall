...
<script>
  ...
  import NavBar from 'components/common/navbar/NavBar'
    ...
    data: function () {
		  return {
		    orderList: [
          {icon: '#order', iconColor: '#ff8198', info: '我的消息',url:'../../../assets/img/profiles/message.png'},
          {icon: '#point', iconColor: '#fc7b53', info: '积分商城',url:'../../../assets/img/profiles/mall.png'},
          {icon: '#vip', iconColor: '#ffc636', info: '会员卡',url:'../../../assets/img/profiles/VIP.png'},
        ],
        serviceList: [
          {icon: '#service', iconColor: '#ff8198', info: '我的购物车',url:'../../../assets/img/profiles/cart.png'},
          {icon: '#download', iconColor: '#ff8198', info: '下载购物APP',url:'../../../assets/img/profiles/download.png'},
        ]
      }
    },
    mounted: function () {
